...
export default function Result ({matchResult, playerName}){
    ...
    return<div className=" flex flex-col gap-10 my-10 w-full justify-center items-center">
        ...
        <PlayerResult name={playerName['1']} win={player1Wins} loss={totalMatches-player1Wins-draws} draw={draws} />
        <PlayerResult name={playerName['2']} win={player2Wins} loss={totalMatches-player2Wins-draws} draw={draws} />
        </div>
