...
export default function Player({playerName,playerNumber,changePlayerName}){
    ...
    return <div className="flex w-fit gap-2 min-[500px]:gap-3 bg-zinc-200 p-2 min-[500px]:p-4 rounded">
        ...
        <input id="playerinput" className="bg-stone-800 max-[500px]:w-64  rounded py-2 px-4 min-[500px]:py-1 min-[500px]:px-2 text-slate-100" value={playerNameState} onChange={isEditing? handleOnchange: null} readOnly={!isEditing}  />
